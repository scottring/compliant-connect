...
ALTER FUNCTION "public"."check_supplier_response_access_and_log"("response_id" "uuid") OWNER TO "postgres";
...
ALTER FUNCTION "public"."create_question_with_tags"("p_subsection_id" "uuid", "p_text" "text", "p_description" "text", "p_type" "public"."question_type__old_version_to_be_dropped", "p_required" boolean, "p_options" "jsonb", "p_tag_ids" "uuid"[]) OWNER TO "postgres";
...
ALTER FUNCTION "public"."is_company_member_or_admin"("p_company_id" "uuid") OWNER TO "postgres";
...
ALTER FUNCTION "public"."update_question_order"("p_updates" "jsonb") OWNER TO "postgres";
...
ALTER FUNCTION "public"."validate_pir_status_transition"() OWNER TO "postgres";
...
ALTER FUNCTION "public"."validate_response_status_transition"() OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."pir_response_comments" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
...
ALTER TABLE "public"."pir_response_comments" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."pir_response_component_materials" (
...
ALTER TABLE "public"."pir_response_component_materials" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."pir_response_components" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
...
ALTER TABLE "public"."pir_response_components" OWNER TO "postgres";
...
ALTER TABLE "public"."v_question_bank_numbered_temp" OWNER TO "postgres";
...
CREATE INDEX "idx_pir_response_comments_response_id" ON "public"."pir_response_comments" USING "btree" ("response_id");



CREATE INDEX "idx_pir_response_comments_user_id" ON "public"."pir_response_comments" USING "btree" ("user_id");
